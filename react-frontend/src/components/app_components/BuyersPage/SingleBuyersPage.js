    ...
    client
      ...
      .then((res) => {
        ...
        const identifierType = Array.isArray(res.identifierType)
          ? res.identifierType.map((elem) => ({
              _id: elem._id,
              identifyType: elem.identifyType,
            }))
          : res.identifierType
            ? [
                {
                  _id: res.identifierType._id,
                  identifyType: res.identifierType.identifyType,
                },
              ]
            : [];
        setIdentifierType(identifierType);
        const buyersAddressCountryName = Array.isArray(
          res.buyersAddressCountryName,
        )
          ? res.buyersAddressCountryName.map((elem) => ({
              _id: elem._id,
          ...
          : res.buyersAddressCountryName
            ? [
                {
                  _id: res.buyersAddressCountryName._id,
                  countryCode: res.buyersAddressCountryName.countryCode,
                },
              ]
            : [];
        ...
        const buyersAddressStateName = Array.isArray(res.buyersAddressStateName)
          ? res.buyersAddressStateName.map((elem) => ({
              _id: elem._id,
          ...
          : res.buyersAddressStateName
            ? [
                {
                  _id: res.buyersAddressStateName._id,
                  stateCode: res.buyersAddressStateName.stateCode,
                },
              ]
            : [];
        setBuyersAddressStateName(buyersAddressStateName);
        const theFirstBuyersContactNumber = Array.isArray(
          res.theFirstBuyersContactNumber,
        )
          ? res.theFirstBuyersContactNumber.map((elem) => ({
              _id: elem._id,
              phoneNumberPrefix: elem.phoneNumberPrefix,
            }))
          : res.theFirstBuyersContactNumber
            ? [
                {
                  _id: res.theFirstBuyersContactNumber._id,
                  phoneNumberPrefix:
                    res.theFirstBuyersContactNumber.phoneNumberPrefix,
                },
              ]
            : [];
        setTheFirstBuyersContactNumber(theFirstBuyersContactNumber);
        const invoiceCurrency = Array.isArray(res.invoiceCurrency)
          ? res.invoiceCurrency.map((elem) => ({
              _id: elem._id,
          ...
          : res.invoiceCurrency
            ? [
                {
                  _id: res.invoiceCurrency._id,
                  currencyCode: res.invoiceCurrency.currencyCode,
                },
              ]
            : [];
        setInvoiceCurrency(invoiceCurrency);
        const frequencyOfBilling = Array.isArray(res.frequencyOfBilling)
          ? res.frequencyOfBilling.map((elem) => ({
              _id: elem._id,
              frequencyOfBilling: elem.frequencyOfBilling,
            }))
          : res.frequencyOfBilling
            ? [
                {
                  _id: res.frequencyOfBilling._id,
                  frequencyOfBilling: res.frequencyOfBilling.frequencyOfBilling,
                },
              ]
            : [];
        setFrequencyOfBilling(frequencyOfBilling);
        const paymentMode = Array.isArray(res.paymentMode)
          ? res.paymentMode.map((elem) => ({
              _id: elem._id,
          ...
          : res.paymentMode
            ? [
                {
                  _id: res.paymentMode._id,
                  paymentMode: res.paymentMode.paymentMode,
                },
              ]
            : [];
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Buyers",
          type: "error",
          message: error.message || "Failed get buyers",
        });
      });
          ...
          <div className="card w-full">
            <div className="grid ">
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Buyer's TIN</label>
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">
                  {_entity?.buyersSstRegistrationNumber}
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Buyer's e-mail</label>
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">
                  {Number(_entity?.buyersAddressPostalZone)}
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
                ...
                <p className="m-0 ml-3">
                  {Number(_entity?.buyersContactNumber)}
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
                ...
                <p className="m-0 ml-3">
                  {Number(_entity?.currencyExchangeRate)}
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Identifier Type</label>
