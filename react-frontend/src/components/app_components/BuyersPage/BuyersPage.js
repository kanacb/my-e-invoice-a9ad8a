  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          buyersName: urlParams.singleCompaniesId,
          identifierType: urlParams.singleIdentifyTypeId,
          buyersAddressCountryName: urlParams.singleCountryCodesId,
          buyersAddressStateName: urlParams.singleStateCodesId,
          theFirstBuyersContactNumber: urlParams.singlePhoneNumberPrefixId,
          invoiceCurrency: urlParams.singleCurrencyCodesId,
          frequencyOfBilling: urlParams.singleFrequencyOfBillingId,
          paymentMode: urlParams.singlePaymentModesId,
          team: urlParams.singleTeamId,
          invoiceId: urlParams.singleInvoicesId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
