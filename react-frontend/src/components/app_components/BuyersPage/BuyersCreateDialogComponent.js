  ...
  const onSave = async () => {
    ...
    try {
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Buyers",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="buyers-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Calendar
              id="billingPeriodStartDate"
              value={
                _entity?.billingPeriodStartDate
                  ? new Date(_entity?.billingPeriodStartDate)
                  : null
              }
              dateFormat="dd/mm/yy"
              onChange={(e) =>
                setValByKey("billingPeriodStartDate", new Date(e.target.value))
              }
              showIcon
              showButtonBar
            />
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Calendar
              ...
              value={
                _entity?.billingPeriodEndDate
                  ? new Date(_entity?.billingPeriodEndDate)
                  : null
              }
              dateFormat="dd/mm/yy"
              onChange={(e) =>
                setValByKey("billingPeriodEndDate", new Date(e.target.value))
              }
              showIcon
              showButtonBar
            />
