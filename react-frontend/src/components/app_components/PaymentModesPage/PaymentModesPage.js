...
const PaymentModesPage = (props) => {
  ...
  const filename = "paymentModes.csv";
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Payment Modes",
          type: "error",
          message: error.message || "Failed get Payment Modes",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("paymentModes").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
        ...
        <div className="col-6 flex justify-content-end">
          <>
            ...
            <Button
              ...
              role="paymentModes-add-button"
            />
          </>
        </div>
      </div>
      <div className="grid align-items-center">
        <div className="col-11" role="paymentModes-datatable">
          <PaymentModesDatatable
            items={data}
            fields={fields}
