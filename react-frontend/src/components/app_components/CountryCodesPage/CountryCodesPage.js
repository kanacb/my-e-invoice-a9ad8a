...
const CountryCodesPage = (props) => {
  ...
  const filename = "countryCodes.csv";
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Country Codes",
          type: "error",
          message: error.message || "Failed get Country Codes",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("countryCodes").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
        ...
        <div className="col-6 flex justify-content-end">
          <>
            ...
            <Button
              ...
              role="countryCodes-add-button"
            />
          </>
        </div>
      </div>
      <div className="grid align-items-center">
        <div className="col-11" role="countryCodes-datatable">
          <CountryCodesDatatable
            items={data}
            fields={fields}
