    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Tax Types",
          type: "error",
          message: error.message || "Failed get Tax Types",
        });
      });
        ...
        <div className="col-6 flex justify-content-end">
          <>
            ...
            <Button
              ...
              role="taxTypes-add-button"
            />
          </>
        </div>
      </div>
      <div className="grid align-items-center">
        <div className="col-11" role="taxTypes-datatable">
          <TaxTypesDatatable
            items={data}
            fields={fields}
