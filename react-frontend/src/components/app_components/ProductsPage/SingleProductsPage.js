...
const SingleProductsPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      .service("products")
      .get(urlParams.singleProductsId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      .then((res) => {
        ...
        const measurement = Array.isArray(res.measurement)
          ...
          : res.measurement
            ? [
                {
                  _id: res.measurement._id,
                  measurement: res.measurement.measurement,
                },
              ]
            : [];
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Products",
          type: "error",
          message: error.message || "Failed get products",
        });
      });
          ...
          <div className="card w-full">
            <div className="grid ">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{Number(_entity?.unitPrice)}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Measurement</label>
