  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          measurement: urlParams.singleMeasurementsId,
          ...
          $populate: [
            ...
            },
            {
              path: "invoiceId",
              service: "invoices",
              select: ["originalEInvoiceReferenceNumber"],
            },
          ],
        },
      })
