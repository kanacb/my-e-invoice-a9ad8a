...
const SuppliersCreateDialogComponent = (props) => {
  ...
  const [theFirstSuppliersContactNumber, setTheFirstSuppliersContactNumber] =
    useState([]);
  ...
  useEffect(() => {
    ...
    client
      ...
      .then((res) => {
        setTheFirstSuppliersContactNumber(
          res.data.map((e) => {
  ...
  const onSave = async () => {
    let _data = {
      suppliersName: _entity?.suppliersName?._id,
      ...
      theFirstSuppliersContactNumber:
        _entity?.theFirstSuppliersContactNumber?._id,
    ...
    try {
      ...
      const eagerResult = await client.service("suppliers").find({
        query: {
          $limit: 10000,
          _id: { $in: [_entity._id] },
          $populate: [
  ...
  const suppliersNameOptions = suppliersName.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  ...
  const theFirstSuppliersContactNumberOptions =
    theFirstSuppliersContactNumber.map((elem) => ({
      name: elem.name,
      value: elem.value,
    }));
  const countryNameOptions = countryName.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  const stateNameOptions = stateName.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
      ...
      >
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="suppliersName"
              value={_entity?.suppliersName?._id}
              optionLabel="name"
              optionValue="value"
              options={suppliersNameOptions}
              onChange={(e) => setValByKey("suppliersName", { _id: e.value })}
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="identifierNumber"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.identifierNumber}
              onChange={(e) => setValByKey("identifierNumber", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              ...
              value={_entity?.theFirstSuppliersContactNumber?._id}
              optionLabel="name"
              optionValue="value"
              options={theFirstSuppliersContactNumberOptions}
              onChange={(e) =>
                setValByKey("theFirstSuppliersContactNumber", { _id: e.value })
              }
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="countryName"
              value={_entity?.countryName?._id}
              optionLabel="name"
              optionValue="value"
              options={countryNameOptions}
              onChange={(e) => setValByKey("countryName", { _id: e.value })}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="stateName"
              value={_entity?.stateName?._id}
              optionLabel="name"
              optionValue="value"
              options={stateNameOptions}
              onChange={(e) => setValByKey("stateName", { _id: e.value })}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="cityName"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.cityName}
              onChange={(e) => setValByKey("cityName", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="postalZone"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.postalZone}
              onChange={(e) => setValByKey("postalZone", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="suppliersBankAccountNumber">
              Supplier's Bank Account Number:
            </label>
            <InputNumber
              id="suppliersBankAccountNumber"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.suppliersBankAccountNumber}
              onChange={(e) =>
                setValByKey("suppliersBankAccountNumber", e.value)
              }
              useGrouping={false}
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="paymentTerms"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.paymentTerms}
              onChange={(e) => setValByKey("paymentTerms", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="prePaymentAmount"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.prePaymentAmount}
              onChange={(e) => setValByKey("prePaymentAmount", e.value)}
              useGrouping={false}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Calendar
              id="prePaymentDate"
              value={
                _entity?.prePaymentDate
                  ? new Date(_entity?.prePaymentDate)
                  : null
              }
              onChange={(e) =>
                setValByKey("prePaymentDate", new Date(e.target.value))
              }
              showIcon
              showButtonBar
            />
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="prePaymentReferenceNumber">
              PrePayment Reference Number:
            </label>
            <InputText
              id="prePaymentReferenceNumber"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.prePaymentReferenceNumber}
              onChange={(e) =>
                setValByKey("prePaymentReferenceNumber", e.target.value)
              }
            />
          </span>
          <small className="p-error">
