  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          suppliersName: urlParams.singleCompaniesId,
          identifierType: urlParams.singleIdentifyTypeId,
          theFirstSuppliersContactNumber: urlParams.singlePhoneNumberPrefixId,
          countryName: urlParams.singleCountryCodesId,
          stateName: urlParams.singleStateCodesId,
