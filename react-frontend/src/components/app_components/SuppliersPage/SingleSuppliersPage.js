  ...
  useEffect(() => {
    ...
    client
      ...
      .then((res) => {
        ...
        const theFirstSuppliersContactNumber = Array.isArray(
          res.theFirstSuppliersContactNumber,
        )
          ? res.theFirstSuppliersContactNumber.map((elem) => ({
              _id: elem._id,
          ...
          : res.theFirstSuppliersContactNumber
            ? [
                {
                  _id: res.theFirstSuppliersContactNumber._id,
                  phoneNumberPrefix:
                    res.theFirstSuppliersContactNumber.phoneNumberPrefix,
                },
              ]
            : [];
        setTheFirstSuppliersContactNumber(theFirstSuppliersContactNumber);
        const countryName = Array.isArray(res.countryName)
          ? res.countryName.map((elem) => ({
              _id: elem._id,
          ...
          : res.countryName
            ? [
                {
                  _id: res.countryName._id,
                  countryCode: res.countryName.countryCode,
                },
              ]
            : [];
        setCountryName(countryName);
        const stateName = Array.isArray(res.stateName)
          ? res.stateName.map((elem) => ({
              _id: elem._id,
          ...
          <div className="card w-full">
            <div className="grid ">
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Supplier's TIN</label>
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{_entity?.identifierNumber}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{_entity?.cityName}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Postal zone</label>
                <p className="m-0 ml-3">{_entity?.postalZone}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
                ...
                <p className="m-0 ml-3">
                  {Number(_entity?.suppliersBankAccountNumber)}
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Payment Terms</label>
                <p className="m-0 ml-3">{_entity?.paymentTerms}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
                  PrePayment Amount
                </label>
                <p className="m-0 ml-3">{Number(_entity?.prePaymentAmount)}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">PrePayment Date</label>
                <p id="prePaymentDate" className="m-0 ml-3">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{_entity?.prePaymentReferenceNumber}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">Supplier's Name</label>
              ...
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">State name</label>
                {stateName.map((elem) => (
