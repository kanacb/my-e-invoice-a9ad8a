...
const InvoicesCreateDialogComponent = (props) => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          $sort: { createdAt: -1 },
          _id: urlParams.singleEInvoiceTypesId,
        },
      })
      .then((res) => {
        setInvoiceType(
          res.data.map((e) => {
            return { name: e["eInvoiceTypes"], value: e._id };
          }),
        );
      })
      .catch((error) => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          $sort: { createdAt: -1 },
          _id: urlParams.singleClassificationCodesId,
        },
      })
      .then((res) => {
        setClassification(
          res.data.map((e) => {
            return { name: e["classificationCode"], value: e._id };
          }),
        );
      })
      .catch((error) => {
        console.log({ error });
        props.alert({
          title: "ClassificationCodes",
          type: "error",
          message: error.message || "Failed get classificationCodes",
        });
      });
  }, []);
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          $sort: { createdAt: -1 },
          _id: urlParams.singleTaxTypesId,
        },
      })
      .then((res) => {
        setTaxType(
          res.data.map((e) => {
            return { name: e["taxType"], value: e._id };
          }),
        );
      })
      .catch((error) => {
        ...
        props.alert({
          title: "TaxTypes",
          type: "error",
          message: error.message || "Failed get taxTypes",
        });
      });
  }, []);
  useEffect(() => {
  ...
  const invoiceTypeOptions = invoiceType.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  const classificationOptions = classification.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  const countryOfOriginOptions = countryOfOrigin.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  const taxTypeOptions = taxType.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  const taxType1Options = taxType1.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  const buyerOptions = buyer.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  const supplierOptions = supplier.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
      ...
      >
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="invoiceType"
              value={_entity?.invoiceType?._id}
              optionLabel="name"
              optionValue="value"
              options={invoiceTypeOptions}
              onChange={(e) => setValByKey("invoiceType", { _id: e.value })}
            />
          </span>
            ...
            <Calendar
              ...
              value={
                _entity?.invoiceDateAndTime
                  ? new Date(_entity?.invoiceDateAndTime)
                  : null
              }
              onChange={(e) =>
                setValByKey("invoiceDateAndTime", new Date(e.target.value))
              }
              showIcon
              showButtonBar
            />
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.no}
              onChange={(e) => setValByKey("no", e.value)}
              useGrouping={false}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="classification"
              value={_entity?.classification?._id}
              optionLabel="name"
              optionValue="value"
              options={classificationOptions}
              onChange={(e) => setValByKey("classification", { _id: e.value })}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="countryOfOrigin"
              value={_entity?.countryOfOrigin?._id}
              optionLabel="name"
              optionValue="value"
              options={countryOfOriginOptions}
              onChange={(e) => setValByKey("countryOfOrigin", { _id: e.value })}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="taxType"
              value={_entity?.taxType?._id}
              optionLabel="name"
              optionValue="value"
              options={taxTypeOptions}
              onChange={(e) => setValByKey("taxType", { _id: e.value })}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="taxRate"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.taxRate}
              onChange={(e) => setValByKey("taxRate", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="taxAmount"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.taxAmount}
              onChange={(e) => setValByKey("taxAmount", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="detailsOfExemption"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.detailsOfExemption}
              onChange={(e) =>
                setValByKey("detailsOfExemption", e.target.value)
              }
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="amountExempted"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.amountExempted}
              onChange={(e) => setValByKey("amountExempted", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="discountRate"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.discountRate}
              onChange={(e) => setValByKey("discountRate", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="discountAmount"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.discountAmount}
              onChange={(e) => setValByKey("discountAmount", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="description1"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.description1}
              onChange={(e) => setValByKey("description1", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="feeChargeRate"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.feeChargeRate}
              onChange={(e) => setValByKey("feeChargeRate", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="feeChargeAmount"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.feeChargeAmount}
              onChange={(e) => setValByKey("feeChargeAmount", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="taxType1"
              value={_entity?.taxType1?._id}
              optionLabel="name"
              optionValue="value"
              options={taxType1Options}
              onChange={(e) => setValByKey("taxType1", { _id: e.value })}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="totalTaxableAmountPerTaxType">
              Total Taxable Amount per Tax Type:
            </label>
            <InputText
              id="totalTaxableAmountPerTaxType"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.totalTaxableAmountPerTaxType}
              onChange={(e) =>
                setValByKey("totalTaxableAmountPerTaxType", e.target.value)
              }
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="totalTaxAmountPerTaxType">
              Total Tax Amount Per Tax Type:
            </label>
            <InputText
              id="totalTaxAmountPerTaxType"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.totalTaxAmountPerTaxType}
              onChange={(e) =>
                setValByKey("totalTaxAmountPerTaxType", e.target.value)
              }
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="detailsOfTaxExemption">
              Details of Tax Exemption:
            </label>
            <InputText
              id="detailsOfTaxExemption"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.detailsOfTaxExemption}
              onChange={(e) =>
                setValByKey("detailsOfTaxExemption", e.target.value)
              }
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="amountExemptedFromTax">
              Amount Exempted from Tax:
            </label>
            <InputNumber
              id="amountExemptedFromTax"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.amountExemptedFromTax}
              onChange={(e) => setValByKey("amountExemptedFromTax", e.value)}
              useGrouping={false}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="discountAmount1"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.discountAmount1}
              onChange={(e) => setValByKey("discountAmount1", e.value)}
              useGrouping={false}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="description3"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.description3}
              onChange={(e) => setValByKey("description3", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              id="feeAmount"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.feeAmount}
              onChange={(e) => setValByKey("feeAmount", e.value)}
              useGrouping={false}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="description4"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.description4}
              onChange={(e) => setValByKey("description4", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field flex">
          <span className="align-items-center">
            ...
            <Checkbox
              id="consolidated"
              className="ml-3"
              checked={_entity?.consolidated}
              onChange={(e) => setValByKey("consolidated", e.checked)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="buyer"
              value={_entity?.buyer?._id}
              optionLabel="name"
              optionValue="value"
              options={buyerOptions}
              onChange={(e) => setValByKey("buyer", { _id: e.value })}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              id="supplier"
              value={_entity?.supplier?._id}
              optionLabel="name"
              optionValue="value"
              options={supplierOptions}
              onChange={(e) => setValByKey("supplier", { _id: e.value })}
            />
          </span>
          <small className="p-error">
