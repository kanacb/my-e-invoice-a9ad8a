...
const InvoicesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("invoices")
            .find({ query: { $limit: 10000 , invoiceType : urlParams.singleEInvoiceTypesId ,classification : urlParams.singleClassificationCodesId ,countryOfOrigin : urlParams.singleCountryCodesId ,taxType : urlParams.singleTaxTypesId ,taxType1 : urlParams.singleTaxTypesId ,team : urlParams.singleTeamId ,buyer : urlParams.singleCompaniesId ,supplier : urlParams.singleCompaniesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
