...
const ShippingFakerDialogComponent = (props) => {
  ...
  const [
    ...
    setshippingRecipientsAddressCountryNameIds,
  ] = useState();
  const [
    shippingRecipientsAddressStateNameIds,
    setshippingRecipientsAddressStateNameIds,
  ] = useState();
  const [
    shippingRecipientsIdentifierTypeIds,
    setshippingRecipientsIdentifierTypeIds,
  ] = useState();
  ...
  const onRun = async () => {
    let fakeData = shippingFakerFactory(
      props.user,
      fakerCount,
    ...
    const promises = fakeData.map((elem) =>
      client.service("shipping").create(elem),
    );
