  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          shippingRecipientsName: urlParams.singleCompaniesId,
          shippingRecipientsAddressCountryName: urlParams.singleCountryCodesId,
          shippingRecipientsAddressStateName: urlParams.singleStateCodesId,
          shippingRecipientsIdentifierType: urlParams.singleIdentifyTypeId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
