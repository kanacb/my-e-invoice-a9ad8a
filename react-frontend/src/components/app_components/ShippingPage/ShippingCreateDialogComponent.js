...
const ShippingCreateDialogComponent = (props) => {
  ...
  const [
    ...
    setShippingRecipientsAddressCountryName,
  ] = useState([]);
  const [
    shippingRecipientsAddressStateName,
    setShippingRecipientsAddressStateName,
  ] = useState([]);
  const [
    shippingRecipientsIdentifierType,
    setShippingRecipientsIdentifierType,
  ] = useState([]);
  ...
  const onSave = async () => {
    ...
    let _data = {
      ...
      shippingRecipientsAddressCountryName:
        _entity?.shippingRecipientsAddressCountryName?._id,
      shippingRecipientsAddressStateName:
        _entity?.shippingRecipientsAddressStateName?._id,
      ...
      shippingRecipientsIdentifierType:
        _entity?.shippingRecipientsIdentifierType?._id,
      ...
      referenceNumberOfCustomsFormNo19Etc:
        _entity?.referenceNumberOfCustomsFormNo19Etc,
      incoterms: _entity?.incoterms,
      freeTradeAgreementFtaInformation:
        _entity?.freeTradeAgreementFtaInformation,
      authorisationNumberForCertifiedExporter:
        _entity?.authorisationNumberForCertifiedExporter,
    ...
    try {
      ...
      const eagerResult = await client.service("shipping").find({
        query: {
          $limit: 10000,
          _id: { $in: [result._id] },
          $populate: [
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Shipping updated successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Shipping",
      });
    }
    setLoading(false);
  };
  ...
  const shippingRecipientsNameOptions = shippingRecipientsName.map((elem) => ({
    name: elem.name,
    value: elem.value,
  }));
  const shippingRecipientsAddressCountryNameOptions =
    shippingRecipientsAddressCountryName.map((elem) => ({
      name: elem.name,
      value: elem.value,
    }));
  const shippingRecipientsAddressStateNameOptions =
    shippingRecipientsAddressStateName.map((elem) => ({
      name: elem.name,
      value: elem.value,
    }));
  const shippingRecipientsIdentifierTypeOptions =
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="shipping-create-dialog-component"
      >
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              ...
              value={_entity?.shippingRecipientsName?._id}
              optionLabel="name"
              optionValue="value"
              options={shippingRecipientsNameOptions}
              onChange={(e) =>
                setValByKey("shippingRecipientsName", { _id: e.value })
              }
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              ...
              value={_entity?.shippingRecipientsAddressCountryName?._id}
              optionLabel="name"
              optionValue="value"
              options={shippingRecipientsAddressCountryNameOptions}
              onChange={(e) =>
                setValByKey("shippingRecipientsAddressCountryName", {
                  _id: e.value,
                })
              }
            />
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              ...
              value={_entity?.shippingRecipientsAddressStateName?._id}
              optionLabel="name"
              optionValue="value"
              options={shippingRecipientsAddressStateNameOptions}
              onChange={(e) =>
                setValByKey("shippingRecipientsAddressStateName", {
                  _id: e.value,
                })
              }
            />
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputNumber
              ...
              onChange={(e) =>
                setValByKey("shippingRecipientsAddressPostalZone", e.value)
              }
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <Dropdown
              ...
              value={_entity?.shippingRecipientsIdentifierType?._id}
              optionLabel="name"
              optionValue="value"
              options={shippingRecipientsIdentifierTypeOptions}
              onChange={(e) =>
                setValByKey("shippingRecipientsIdentifierType", {
                  _id: e.value,
                })
              }
            />
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.billReferenceNumber}
              onChange={(e) =>
                setValByKey("billReferenceNumber", e.target.value)
              }
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="referenceNumberOfCustomsFormNo19Etc">
              Reference Number of Customs Form No.1, 9, etc.:
            </label>
            <InputText
              id="referenceNumberOfCustomsFormNo19Etc"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.referenceNumberOfCustomsFormNo19Etc}
              onChange={(e) =>
                setValByKey(
                  "referenceNumberOfCustomsFormNo19Etc",
                  e.target.value,
          ...
          <small className="p-error">
            {!_.isEmpty(error["referenceNumberOfCustomsFormNo19Etc"]) ? (
              <p
                className="m-0"
                key="error-referenceNumberOfCustomsFormNo19Etc"
              >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="incoterms"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.incoterms}
              onChange={(e) => setValByKey("incoterms", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="freeTradeAgreementFtaInformation">
              Free Trade Agreement (FTA) Information:
            </label>
            <InputTextarea
              id="freeTradeAgreementFtaInformation"
              rows={5}
              cols={30}
              value={_entity?.freeTradeAgreementFtaInformation}
              onChange={(e) =>
                setValByKey("freeTradeAgreementFtaInformation", e.target.value)
              }
              autoResize
            />
          </span>
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="authorisationNumberForCertifiedExporter">
              Authorisation Number for Certified Exporter:
            </label>
            <InputText
              id="authorisationNumberForCertifiedExporter"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.authorisationNumberForCertifiedExporter}
              onChange={(e) =>
                setValByKey(
                  "authorisationNumberForCertifiedExporter",
                  e.target.value,
          ...
          <small className="p-error">
            {!_.isEmpty(error["authorisationNumberForCertifiedExporter"]) ? (
              <p
                className="m-0"
                key="error-authorisationNumberForCertifiedExporter"
              >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            <label htmlFor="referenceNumberOfCustomsFormNo2">
              Reference Number of Customs Form No.2:
            </label>
            <InputText
              id="referenceNumberOfCustomsFormNo2"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.referenceNumberOfCustomsFormNo2}
              onChange={(e) =>
                setValByKey("referenceNumberOfCustomsFormNo2", e.target.value)
              }
            />
          </span>
          <small className="p-error">
