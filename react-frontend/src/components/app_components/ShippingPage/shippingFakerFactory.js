...
export default (
  user,
  count,
  shippingRecipientsNameIds,
  shippingRecipientsAddressCountryNameIds,
  shippingRecipientsAddressStateNameIds,
  shippingRecipientsIdentifierTypeIds,
) => {
  let data = [];
  for (let i = 0; i < count; i++) {
    const fake = {
      shippingRecipientsName:
        shippingRecipientsNameIds[i % shippingRecipientsNameIds.length],
      shippingRecipientsAddressCountryName:
        shippingRecipientsAddressCountryNameIds[
          i % shippingRecipientsAddressCountryNameIds.length
        ],
      shippingRecipientsAddressStateName:
        shippingRecipientsAddressStateNameIds[
          i % shippingRecipientsAddressStateNameIds.length
        ],
      ...
      shippingRecipientsIdentifierType:
        shippingRecipientsIdentifierTypeIds[
          i % shippingRecipientsIdentifierTypeIds.length
        ],
