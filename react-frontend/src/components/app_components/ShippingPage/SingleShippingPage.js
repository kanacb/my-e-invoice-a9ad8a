...
const SingleShippingPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      .service("shipping")
      .get(urlParams.singleShippingId, {
        query: {
          $populate: [
            {
              path: "createdBy",
      ...
      .then((res) => {
        ...
        const shippingRecipientsName = Array.isArray(res.shippingRecipientsName)
          ? res.shippingRecipientsName.map((elem) => ({
              _id: elem._id,
              name: elem.name,
            }))
          : res.shippingRecipientsName
            ? [
                {
                  _id: res.shippingRecipientsName._id,
                  name: res.shippingRecipientsName.name,
                },
              ]
            : [];
        setShippingRecipientsName(shippingRecipientsName);
        const shippingRecipientsAddressCountryName = Array.isArray(
          res.shippingRecipientsAddressCountryName,
        )
          ? res.shippingRecipientsAddressCountryName.map((elem) => ({
              _id: elem._id,
          ...
          : res.shippingRecipientsAddressCountryName
            ? [
                {
                  _id: res.shippingRecipientsAddressCountryName._id,
                  countryCode:
                    res.shippingRecipientsAddressCountryName.countryCode,
                },
              ]
            : [];
        setShippingRecipientsAddressCountryName(
        ...
        const shippingRecipientsAddressStateName = Array.isArray(
          res.shippingRecipientsAddressStateName,
        )
          ? res.shippingRecipientsAddressStateName.map((elem) => ({
              _id: elem._id,
          ...
          : res.shippingRecipientsAddressStateName
            ? [
                {
                  _id: res.shippingRecipientsAddressStateName._id,
                  stateCode: res.shippingRecipientsAddressStateName.stateCode,
                },
              ]
            : [];
        setShippingRecipientsAddressStateName(
        ...
        const shippingRecipientsIdentifierType = Array.isArray(
          res.shippingRecipientsIdentifierType,
        )
          ? res.shippingRecipientsIdentifierType.map((elem) => ({
              _id: elem._id,
          ...
          : res.shippingRecipientsIdentifierType
            ? [
                {
                  _id: res.shippingRecipientsIdentifierType._id,
                  identifyType:
                    res.shippingRecipientsIdentifierType.identifyType,
                },
              ]
            : [];
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Shipping",
          type: "error",
          message: error.message || "Failed get shipping",
        });
      });
          ...
          <div className="card w-full">
            <div className="grid ">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">
                  {Number(_entity?.shippingRecipientsAddressPostalZone)}
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{_entity?.billReferenceNumber}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">{_entity?.incoterms}</p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
              ...
              <div className="col-12 md:col-6 lg:col-3">
                ...
                <p className="m-0 ml-3">
                  {_entity?.referenceNumberOfCustomsFormNo2}
                </p>
              </div>
              <div className="col-12 md:col-6 lg:col-3">
                <label className="text-sm text-gray-600">
