...
const StateCodesPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "State Codes",
          type: "error",
          message: error.message || "Failed get State Codes",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("stateCodes").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
        ...
        <div className="col-6 flex justify-content-end">
          <>
            ...
            <Button
              ...
              role="stateCodes-add-button"
            />
          </>
        </div>
      </div>
      <div className="grid align-items-center">
        <div className="col-11" role="stateCodes-datatable">
          <StateCodesDatatable
            items={data}
            fields={fields}
